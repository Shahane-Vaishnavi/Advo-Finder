...
export default function AdvocateLogin({ setCurrentPage, onLogin }) {
  ...
  const handleLoginSubmit = async (e) => {
    ...
    try {
      ...
      const response = await authAPI.loginAdvocate(formData);
      
      // Store token
      tokenStorage.setToken(response.data.access_token);
      
      // Call onLogin callback
      onLogin(response.data.advocate);
  ...
  return (
    <div className="auth-container">
      <div className="auth-card advocate-card">
        ...
        <p className="subtitle">Login to your advocate account</p>
        ...
        <form onSubmit={handleLoginSubmit}>
          ...
          <p className="auth-link">
            Not registered yet?{' '}
            <a onClick={() => setCurrentPage('advocateRegistration')} className="link">
              Register here
            </a>
          </p>
